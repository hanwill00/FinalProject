...
ActiveRecord::Schema.define(version: 20180424210649) do
  ...
  create_table "itinerary_followings", force: :cascade do |t|
    t.integer "itinerary_id"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["itinerary_id"], name: "index_itinerary_followings_on_itinerary_id"
    t.index ["user_id"], name: "index_itinerary_followings_on_user_id"
  end
